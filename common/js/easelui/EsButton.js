...
function EsButton(text, option)
{
    ...
    if(settings.border)
	   this.base_.graphics.setStrokeStyle(settings.border).beginStroke(settings.borderColor).drawRoundRect(0, 0, width+DOUBLE_BORDER, height+DOUBLE_BORDER, DOUBLE_BORDER);
